...
use Carbon\Carbon;
use DB;
use Dikpro2\DetalleOrden;
use Dikpro2\Http\Requests\OrdenesFormRequest;
use Dikpro2\Ordenes;
use Dikpro2\Persona;
use Dikpro2\Proceso;
use Dikpro2\Productos;
use Dikpro2\Servicios;
use Dikpro2\User;
    ...
    public function show($id)
    {
        ...
        function diferenciafecha($fecha1, $fecha2)
        {
            ...
            if ($respuesta->y == 0 && $respuesta->m == 0 && $respuesta->d == 0 && $respuesta->h == 0 && $respuesta->i == 0 && $respuesta->s == 0) {
                ...
                $respuesta = $respuesta->y . 'a«Ð ' .$respuesta->m . 'me ' . $respuesta->d . 'd ' . $respuesta->h . 'ho ' . $respuesta->i . 'min ' . $respuesta->s . 'seg';
                return $respuesta;
            }
            return $respuesta;
        }
        ...
        $disenador = consultaasignados($id, 5); //comprueba que el diseÃ±ador asignado
