...
use DB;
use Dikpro2\Departamentos;
use Dikpro2\Empleado;
use Dikpro2\Http\Requests\EditarEmpleadoFormRequest;
use Dikpro2\Http\Requests\EmpleadoFormRequest;
use Dikpro2\TipoEmpleado;
use Dikpro2\User;
