                ...
                <div class="form-group">
                    <div class="small-box bg-aqua">
                        <div class="inner">
                            ...
                            <p>
                                {{$proceso->descripcion_procesos}} - {{$proceso->num_factura}}
                            </p>
                            <p id="fecha">
...
<script>
    function titulo(){      
    document.title = 'Proceso Orden # '+{{$proceso->tb_ordenes_id_tb_ordenes}}+' | Procesos'; }
titulo();
</script>
<script>
    moment.locale('es');
    var formatofecha = '{{$proceso->tb_fecha_hora}}'; 
